...
mediumInstall::mediumInstall(QWidget *parent)
    : QWidget(parent)
    , m_pTopLabel(new DLabel(tr("中期安装")))
    , m_pCentralLabel(new DLabel(tr("请选择中期安装")))
    ...
    , MainLayout(new QVBoxLayout(this))
{
    ...
    connect(m_pCommandChooseButton,&DCommandLinkButton::clicked,this,&mediumInstall::chooseButtonSlots,Qt::QueuedConnection);
    connect(m_pCommandEraseButton,&DCommandLinkButton::clicked,this,&mediumInstall::eraseButtonSlots,Qt::QueuedConnection);
    connect(m_pButton,&DPushButton::clicked,this,&mediumInstall::clikedButton,Qt::QueuedConnection);
}


mediumInstall::~mediumInstall()
{

}

void mediumInstall::chooseButtonSlots()
{
...
void mediumInstall::eraseButtonSlots()
{
...
void mediumInstall::clikedButton()
{
    emit clikedNext();
}
