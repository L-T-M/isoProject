...
previousPreparation::previousPreparation(QWidget *parent)
    : QWidget(parent)
    , m_pTopLabel(new DLabel(tr("前期准备")))
    , m_pCentralLabel(new DLabel(tr("请选择前期准备")))
    ...
    , MainLayout(new QVBoxLayout(this))
{
    ...
    connect(m_pCommandChooseButton,&DCommandLinkButton::clicked,this,&previousPreparation::chooseButtonSlots,Qt::QueuedConnection);
    connect(m_pCommandEraseButton,&DCommandLinkButton::clicked,this,&previousPreparation::eraseButtonSlots,Qt::QueuedConnection);
    connect(m_pButton,&DPushButton::clicked,this,&previousPreparation::clikedButton,Qt::QueuedConnection);
}
...
void previousPreparation::chooseButtonSlots()
{
...
void previousPreparation::eraseButtonSlots()
{
...
void previousPreparation::clikedButton()
{
    emit clikedNext();
}
